...
$string['feedbackfiles_update_summary'] = '{$a->total} feedback file(s) will be added or modified.';
$string['feedbackfiles_update_summary_desc'] = 'New feedback files';
...
$string['filesadded'] = 'Feedback files added';
$string['filesupdated'] = 'Feedback files updated';
...
$string['uploadzipsummaryintro'] = 'Feedback has been updated from the zip file.';
$string['userswithnewfeedback'] = 'Users with updated feedback';
